...
- Remember to level the bed: paper width at the 4 corners of the bed twice
...
- ``View/Workbench/Part Design`` => this also enables the delete option for the parts
- If accidentally close the left panel, do ``View/Panels/Combo View``
...
- If you see white edges in the solid view, toggle the view of the sketch; otherwise, the white edges will block the selection
- If want to move a part in an assembly, on the part from the left panel, ``right-click Transform/OK/right-click Transform`` and then drag the arrows to move each part
