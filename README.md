...
- If want to move a part in an assembly, on the part from the left panel, ``right-click Transform/OK/right-click Transform`` and then drag the arrows to move each parts
